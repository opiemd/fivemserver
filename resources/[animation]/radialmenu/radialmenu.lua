...
RegisterCommand("Arbeit", function(source, args, rawCommand)
    ...
    SendNUIMessage({
        type = 'init',
        data = subMenuConfigs["Arbeit"].data,
        resourceName = GetCurrentResourceName()
    })
    SetNuiFocus(true, true)
end, false)

RegisterCommand("Animationen", function(source, args, rawCommand)
    -- Wait for next frame just to be safe
    Citizen.Wait(0)
    ...
    SendNUIMessage({
        type = 'init',
        data = subMenuConfigs["Animationen"].data,
        resourceName = GetCurrentResourceName()
    })
    SetNuiFocus(true, true)
end, false)

RegisterCommand("Tänze", function(source, args, rawCommand)
    -- Wait for next frame just to be safe
    Citizen.Wait(0)
    ...
    SendNUIMessage({
        type = 'init',
        data = subMenuConfigs["Tänze"].data,
        resourceName = GetCurrentResourceName()
    })
    SetNuiFocus(true, true)
end, false)

RegisterCommand("Laufstil", function(source, args, rawCommand)
    -- Wait for next frame just to be safe
    Citizen.Wait(0)
    ...
    SendNUIMessage({
        type = 'init',
        data = subMenuConfigs["Laufstil"].data,
        resourceName = GetCurrentResourceName()
    })
    SetNuiFocus(true, true)
end, false)

RegisterCommand("Verschiedenes", function(source, args, rawCommand)
    -- Wait for next frame just to be safe
    Citizen.Wait(0)
    ...
    SendNUIMessage({
        type = 'init',
        data = subMenuConfigs["Verschiedenes"].data,
        resourceName = GetCurrentResourceName()
    })
    SetNuiFocus(true, true)
end, false)
