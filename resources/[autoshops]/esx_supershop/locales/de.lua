Locales['de'] = {
  ...
  ['super_belongs']       = 'Ein Fahrzeug mit dem Nummernschild ~y~%s~s~ gehört jetzt ~b~dir~s~',
  ['generic_shopitem']    = '$%s',
  ['super_dealer']        = 'Supersportwagen Händler',
  ['buy_super_shop']      = 'Möchtest du %s mit %s kg Kofferraum für $%s kaufen?',
  ['no']                  = 'Nein',
  ['yes']                 = 'Ja',
  ['super_purchased']     = 'Du hast ein Fahrzeug gekauft',
  ...
  ['super_sold_for']      = 'Dein ~b~%s~s~ wurden ~y~Verkauft~s~ für ~g~$%s~s~',
