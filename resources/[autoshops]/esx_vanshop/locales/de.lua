Locales['de'] = {
  ...
  ['van_belongs']       = 'Ein Fahrzeug mit dem Nummernschild ~y~%s~s~ gehört jetzt ~b~dir~s~',
  ['generic_shopitem']    = '$%s',
  ['van_dealer']        = 'Van Händler',
  ['buy_van_shop']      = 'Möchtest du %s mit %s kg Kofferraum für $%s kaufen?',
  ['no']                  = 'Nein',
  ['yes']                 = 'Ja',
  ['van_purchased']     = 'Du hast ein Fahrzeug gekauft',
  ...
  ['van_sold_for']      = 'Dein ~b~%s~s~ wurden ~y~Verkauft~s~ für ~g~$%s~s~',
