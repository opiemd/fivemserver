...
AddEventHandler('eden_accesories:silencieux', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used < silencieux then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("Du hast gerade deine waffe mit einem Schalldämpfer ausgerüstet.")) 
		  		 	used = used + 1
	...
	used = used + 1
		  		  ...
		  		  ESX.ShowNotification(("Du hast keine Waffe in der Hand oder deine Waffe kann keinen Schalldämpfer tragen."))
		  		
			end
			else
					  		 ESX.ShowNotification(("Du hast alle deine Schalldämpfer verwenden.")) 
...
AddEventHandler('eden_accesories:flashlight', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used2 < flashlight then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("Du hast gerade deine Handwaffe mit einer Lampe ausgerüstet.")) 
		  		 	used2 = used2 + 1
		  	elseif currentWeaponHash == GetHashKey("WEAPON_PISTOL50") then
	...
	used2 = used2 + 1
		  		  ...
		  		  ESX.ShowNotification(("Du hast keine Waffe in der Hand oder deine Waffe kann mit einer Lampe nicht ausgerüstet werden."))
		  		
			end
		else
				  		  ESX.ShowNotification(("Du hast alle deine Lampen verwendet."))
...
AddEventHandler('eden_accesories:grip', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used3 < grip then
			...
			if currentWeaponHash == GetHashKey("WEAPON_COMBATPDW") then
		  		 ...
		  		 ESX.ShowNotification(("Du hast gerade deine Handwaffe mit einem Griff ausgerüstet.")) 
		  				used3 = used3 + 1
	...
	used3 = used3 + 1
		  		  ...
		  		  ESX.ShowNotification(("Du hast keine Waffe in der Hand oder deine Waffe kann nicht damit umgehen."))
		  		
			end
		else
				  		  ESX.ShowNotification(("Du hast alle deine Griffe verwendet."))
		end
end)
...
AddEventHandler('eden_accesories:yusuf', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used4 < yusuf then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("Du hast gerade deine Handwaffe mit einem Luxus-Skins ausgerüstet.")) 
		  		 	used4 = used4 + 1
	...
	used4 = used4 + 1
		  		  ...
		  		  ESX.ShowNotification(("Du hast keine Waffe in der Hand oder deine Waffe kann keine Luxus-Skins tragen."))
		  		
			end
		else
				  		  ESX.ShowNotification(("Du hast alle deine Luxus-Skins verwendet."))
