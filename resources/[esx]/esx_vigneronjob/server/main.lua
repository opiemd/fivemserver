...
AddEventHandler('esx_vigneronjob:startHarvest', function(zone)
	...
	if PlayersHarvesting[_source] == false then
		TriggerClientEvent('esx:showNotification', _source, '~r~Versuche es nochmal~w~')
...
AddEventHandler('esx_vigneronjob:stopHarvest', function()
	...
	if PlayersHarvesting[_source] == true then
		PlayersHarvesting[_source]=false
		TriggerClientEvent('esx:showNotification', _source, 'Du verlässt die ~r~Zone')
	else
		TriggerClientEvent('esx:showNotification', _source, 'Du kannst nichts mehr ~g~ernten')
		PlayersHarvesting[_source]=true
	end
end)
...
AddEventHandler('esx_vigneronjob:stopTransform', function()
	...
	if PlayersTransforming[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Du kannst deine Trauben ~g~Verarbeiten')
		PlayersTransforming[_source]=true
