...
RegisterServerEvent('esx_sand:startHarvestTurtle')
AddEventHandler('esx_sand:startHarvestTurtle', function()
...
RegisterServerEvent('esx_sand:stopHarvestTurtle')
AddEventHandler('esx_sand:stopHarvestTurtle', function()
...
local function TransformTurtle(source)
	...
	SetTimeout(Config.TimeToProcess, function()
		...
		if PlayersTransformingTurtle[source] == true then
			...
			local turtleQuantity = xPlayer.getInventoryItem('sand').count
			local meatQuantity = xPlayer.getInventoryItem('glas').count
			...
			elseif turtleQuantity < 5 then
				...
				xPlayer.removeInventoryItem('sand', 5)
				xPlayer.addInventoryItem('glas', 1)
...
RegisterServerEvent('esx_sand:startTransformTurtle')
AddEventHandler('esx_sand:startTransformTurtle', function()
...
RegisterServerEvent('esx_sand:stopTransformTurtle')
AddEventHandler('esx_sand:stopTransformTurtle', function()
	...
	SetTimeout(Config.TimeToSell, function()
		...
		if PlayersSellingTurtle[source] == true then
			...
			if meatQuantity == 0 then
				...
				xPlayer.removeInventoryItem('glas', 1)
					local num = 75
					xPlayer.addMoney(35)
...
RegisterServerEvent('esx_sand:startSellTurtle')
AddEventHandler('esx_sand:startSellTurtle', function()
...
RegisterServerEvent('esx_sand:stopSellTurtle')
AddEventHandler('esx_sand:stopSellTurtle', function()
...
RegisterServerEvent('esx_sand:GetUserInventory')
AddEventHandler('esx_sand:GetUserInventory', function(currentZone)
	local _source = source
    local xPlayer  = ESX.GetPlayerFromId(_source)
    TriggerClientEvent('esx_sand:ReturnInventory', 
    	_source,
		xPlayer.getInventoryItem('sand').count, 
		xPlayer.getInventoryItem('glas').count,
		xPlayer.job.name, 
		currentZone
    )
end)
