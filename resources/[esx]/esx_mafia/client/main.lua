...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    ESX.TriggerServerCallback('esx_society2:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society2:removeVehicleFromGarage', 'mafia', vehicleProps)
...
AddEventHandler('esx_mafiajob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'AircraftSpawner' then
    ...
    local aircrafts = Config.MafiaStations[station].Aircrafts

    if not IsAnyVehicleNearPoint(aircrafts[partNum].SpawnPoint.x, aircrafts[partNum].SpawnPoint.y, aircrafts[partNum].SpawnPoint.z,  3.0) then

      ESX.Game.SpawnVehicle('maverick', {
        x = aircrafts[partNum].SpawnPoint.x,
        y = aircrafts[partNum].SpawnPoint.y,
        z = aircrafts[partNum].SpawnPoint.z
      }, aircrafts[partNum].Heading, function(vehicle)
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society2:putVehicleInGarage', 'mafia', vehicleProps)
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society2:openBossMenu', 'mafia', function(data, menu)
