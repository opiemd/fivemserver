...
local voice = {default = 5.0, shout = 12.0, whisper = 0.5, mute = 0, current = 2, level = nil}
...
function drawLevel(r, g, b, a)
	...
	EndTextCommandDisplayText(0.300, 0.92)
end
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustPressed(1, Keys['Z']) then --and IsControlPressed(1, Keys['LEFTSHIFT']) then
