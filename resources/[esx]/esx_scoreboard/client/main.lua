...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, mafia, police, taxi, mechanic, cardealer, estate, players = 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, mafia = mafia, police = police, taxi = taxi, mechanic = mechanic, cardealer = cardealer, estate = estate, player_count = players}
	})
end
