...
function UpdatePlayerTable(connectedPlayers)
	...
	local ems, police, mafia, taxi, mechanic, cardealer, estate, players = 0, 0, 0, 0, 0, 0, 0, 0
	...
	SendNUIMessage({
		...
		jobs   = {ems = ems, police = police, mafia = mafia, sheriff = sheriff, taxi = taxi, mechanic = mechanic, cardealer = cardealer, estate = estate, player_count = players}
	})
...
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		if PlayerData.job ~= nil and (PlayerData.job.name == 'mafia' or PlayerData.job.name == 'admin') then
