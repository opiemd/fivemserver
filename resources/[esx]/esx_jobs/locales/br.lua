Locales['br'] = {
  ...
  -- Fazendeiro
  ['ble']                    = "Trigo",
  ['m_fermier_locker']       = "Companhia de Agricultura",
  ['m_ble']                  = 'Campo de Trigo',
  ['m_recoltble']            = 'pressione ~INPUT_PICKUP~ para pegar o Trigo.',
  ['m_ble_smelting']         = 'Muedor de Trigo',
  ['m_farine']               = 'farinha',
  ['m_sell_farine']          = 'revenda de farinha',
  ['m_deliver_farine']       = 'pressione ~INPUT_PICKUP~ para vender farinha.',
  ['m_ble_button']           = 'pressione ~INPUT_PICKUP~ para moer o trigo.',
}
