      ...
      if IsControlPressed(0, Keys['E']) then
        ...
        if CurrentAction == 'mechanic_duty' then
          if PlayerData.job.name == 'mechanic' or PlayerData.job.name == 'offmechanic' then
			...
			exports.ft_libs:EnableArea("esx_eden_garage_area_mechanic_mecanodeletepoint")
			exports.ft_libs:EnableArea("esx_eden_garage_area_mechanic_mecanospawnpoint")
          if PlayerData.job.name == 'mechanic' then
            sendNotification(_U('offduty'), 'success', 2500)
            exports.ft_libs:DisableArea("esx_eden_garage_area_mechanic_mecanodeletepoint")
            exports.ft_libs:DisableArea("esx_eden_garage_area_mechanic_mecanospawnpoint")
            Wait(1000)
          else
            sendNotification(_U('onduty'), 'success', 2500)
            Wait(1000)
          ...
          sendNotification(_U('notacl'), 'error', 5000)
          Wait(1000)
          end
        end
      end
