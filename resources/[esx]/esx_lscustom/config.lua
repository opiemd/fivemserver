...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -222.86, y = -1329.92, z = 30.89},
	...
	ls2 = {
		Pos   = { x = -213.92, y = -1321.36, z = 30.89},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = -222.85, y = -1324.14, z = 30.89},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = -210.53, y = -1316.21, z = 30.89},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls5 = {
		Pos   = { x = -199.14, y = -1324.44, z = 30.89},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
