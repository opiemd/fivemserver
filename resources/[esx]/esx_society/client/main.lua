...
function RefreshBussHUD()
	...
	elseif ESX.PlayerData.job.grade > Config.BossManagementGrade then
		EnableSocietyMoneyHUDElement()
...
AddEventHandler('esx_addonaccount:setMoney', function(society, money)
	if ESX.PlayerData.job and ESX.PlayerData.job.grade_name == 'boss' and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	elseif ESX.PlayerData.job and ESX.PlayerData.job.grade > Config.BossManagementGrade and 'society_' .. ESX.PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)
