		...
		if data.current.value == 'vehicle_list' then
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				local elements = {
					...
					{label = _U('letti500'), value = 'coe54t'}
				}
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, Keys['E']) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'bennys' then
		...
		if IsControlJustReleased(0, Keys['F6']) and not isDead and ESX.PlayerData.job and ESX.PlayerData.job.name == 'bennys' then
			OpenMobileMechanicActionsMenu()
		end

		if IsControlJustReleased(0, Keys['DELETE']) and not isDead and ESX.PlayerData.job and ESX.PlayerData.job.name == 'bennys' then
			if NPCOnJob then
