...
function OpenRadioMenu()
  ...
  local elements = {
    ...
    if (PlayerData.job.name == 'police' or PlayerData.job.name == 'fire' or PlayerData.job.name == 'state' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'policeambulance' or PlayerData.job.name == 'mafia') then
...
if channel == 21 then
          exports.tokovoip_script:removePlayerFromRadio(21)
    end
if channel == 1 then
...
if channel == 20 then
      ...
      if channel == 21 then
        exports.tokovoip_script:removePlayerFromRadio(21)
    		  ...
    		  exports.tokovoip_script:addPlayerToRadio(1) -- PD Radio 
		channel = 1
      end
      ...
      if data.current.value == 'radio11' then -- ADmin 
        ...
        if channel == 1 then
                exports.tokovoip_script:removePlayerFromRadio(1)
                  ...
                  exports.tokovoip_script:addPlayerToRadio(21) -- Admin 
            channel = 21
              end 
