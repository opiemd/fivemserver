...
function OpenBikeMenu()
    ...
    ESX.UI.Menu.Open(
        ...
        {
            title    = 'Miete ein Bike',
            elements = {
				{label = 'BMX ($1)', value = 'bmx'},
				{label = 'Cruiser ($1)', value = 'cruiser'},
				{label = 'Fixter ($1)', value = 'fixter'},
				{label = 'Scorcher ($1)', value = 'scorcher'},
            }
        },
        function(data, menu)
