...
AddTextEntry(controllerMessageLoweredCar, "Drücke ~INPUT_CONTEXT~ zum ~y~Hochziehen ~w~der Rampe.~n~Drücke ~INPUT_DETONATE~ zum ~r~ablassen ~w~des Fahrzeugs.")
AddTextEntry(controllerMessageLoweredNoCar, "Drücke ~INPUT_CONTEXT~ zum ~y~Hochziehen ~w~der Rampe.~n~Drücke ~INPUT_DETONATE~ zum ~g~Festmachen ~w~des Fahrzeugs.")
AddTextEntry(controllerMessageRaised, "Drücke ~INPUT_CONTEXT~ zum ~y~ablassen ~w~der Rampe.")
